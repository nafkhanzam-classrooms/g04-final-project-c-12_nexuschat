...
# key   : username (str)
# value : dict { "socket": socket, "room": str | None }
...
# Semua room yang aktif
# key   : room_name (str)
# value : dict { "creator": str, "members": list[str] }
rooms: dict[str, dict] = {}
...
# Riwayat pesan per room (maksimal MAX_HISTORY pesan terakhir)
# key   : room_name (str)
# value : list of dict { "sender": str, "content": str, "timestamp": str }
chat_history: dict[str, list] = {}
chat_history_lock = threading.Lock()
 
MAX_HISTORY = 50    # Jumlah pesan yang disimpan per room
...
def add_history(room_name: str, sender: str, content: str, timestamp: str):
    ...
    with chat_history_lock:
        ...
        # Buang pesan lama kalau sudah melebihi batas
